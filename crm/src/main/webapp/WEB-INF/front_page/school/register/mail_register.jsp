...
<form id="myform">
	<input type="text" onblur="check_mail()" name="user_mail"
		id="user_mail" placeholder="邮箱" class="mail" style="margin-top: 30px;">
	<i class="mailicon"></i> <b class="dui dui1"></b> <b class="cuo cuo1"></b>
	...
	<div class="iargee1">
		<input type="checkbox" id="check_xieyi" class="check1"> <span
			class="iargee">我同意<span class="xieyi">《京人网校注册协议》</span></span>
	</div>
	<div class='tishi tishi6' style="color: red;">你没有同意本网站注册协议！</div>
	<a class="zhucebu" onclick="register_user('${jr_url}','mail')">注册</a>
</form>