...
<title>网校后台管理系统</title>
	...
	<link rel="stylesheet" type="text/css" href="/css/school/back/common/htindex.css">
...
<body>
	<div class='wrapper'>
		<!-- 左侧菜单列表 -->
		<jsp:include page="/WEB-INF/back_page/common/menu.jsp"></jsp:include>
		<div class="ht_right"  id="conten_list">
			<!-- 右侧内容 -->
			<jsp:include page="/WEB-INF/back_page/welcome.jsp"></jsp:include>
		</div>
	</div>
</body>
</html>