...
<script>
function add_zhanghao(consult_id){
	var employee_id=$("#employee_id").val();
	$.post("/net_conult/update_net_conult_employee.jr",{
...
<body>
	<div style="padding: 20px;">
		...
		<label class="col-xs-3">&nbsp;</label>
		<a class="xiazai" onclick="add_zhanghao(${consult_id})" href="javascript:void(0)">转移</a>
	</div>
</body>
</html>