...
<link rel="stylesheet" type="text/css"
	href="/css/school/back/common/tipso.min.css">
...
<div class="ht_left">
	<div class="sidebarone">
		<div class="left_logo">
			...
			<div class="left_back">
				<img src="/images/school/back/left/side_left.png" onclick="shouqi()"
					id="left_backside">
			</div>
		</div>
	...
	<div class="bar_bottom_wai">
		<div class="bar_bottom">
			<div class="bar_bottom1 hvr-sweep-to-right" onclick="location.href='/center/get_employee_center.jr'">
				<c:if
					test="${not empty sessionScope.employee_session.employee_pic }">
					<img src="${sessionScope.employee_session.employee_pic }"
						class="emp_pic" />
				</c:if>
