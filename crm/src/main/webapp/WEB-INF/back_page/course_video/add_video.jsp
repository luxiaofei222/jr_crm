...
function check_video_dis(){
	...
	if(video_dis!=null&&video_dis!=""){
		if(video_dis.length>55){
			layer.msg('课程描述字数不得超过55个！');
			return false;
		}else{
	...
	if(file_upload!=null&&file_upload!=""){
	 if (check_course_name()&&check_video_dis()) {
		 ...
		 $("#myform").ajaxSubmit({
				...
				url : "/back_video/save_course_video.jr",
				success : function(data) {
					if(data==1){
						tanchuang("提示：恭喜您，添加课程成功！");
						$('#myform')[0].reset();
...
function get_sub_course(){
	...
	//切换老师
	$.post("/back_video/get_teacher_list.jr",{
		'course_id':course_parent_id,
		'type':1
	},function(data){
...
<div class="back_right" style="min-width: 900px;">
    ...
    <div class="form-group">
      ...
      <div class="col-lg-9">
        <input type="text" onblur="check_course_name()" class="form-control" name="video_name" id="video_name" placeholder="课程名称">
      </div>
      <div id="panduan2"></div>
    </div>
    <div class="form-group">
      <label class="col-lg-2 control-label">课程分类：</label>
      <div class="col-lg-3">
    ...
    <div class="form-group">
	  ...
	  <label class="col-lg-2 control-label">班型：</label>    
      <div class="col-lg-3">
	    <select  name="banxing" id="banxing" class="form-control select select-primary">
          ...
          <option value="VIP班">VIP班</option>
        </select>    
  	  </div>
    </div>
    <div class="form-group">
      <label class="col-lg-2 control-label">主讲教师：</label>
      <div class="col-lg-3">
      ...
      <div class="col-lg-3">
        <input type="text" class="form-control" value="0.00" name="video_money_now" id="video_money_now" placeholder="价格"> 
      </div> 
    </div>
     <div class="form-group">
      <label class="col-lg-2 control-label">到期时间：</label>
      <div class="col-lg-3">
        <input type="text" class="form-control"  name="daoqi_time_str" id="daoqi_time" placeholder="请选择到期时间"> 
      </div>
      <script>
    ...
    <div class="form-group">
      ...
      <div class="col-lg-9">
        <input type="text" class="form-control" onblur="check_video_dis()" name="video_dis" id="video_dis" placeholder="课程描述"> 
      </div>
      <div id="panduan3"></div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="col-lg-9">
        <button type="button" onclick="add_course_video()" class="btn btn-success btn-xm">提交</button>
