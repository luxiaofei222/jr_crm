...
<script>
  ...
  //保存章节名称
  function save_zhang(video_id){
	  if (check_zhang_name()) {
			$("#myform").ajaxSubmit({
				type : 'POST',
				url : "/back_video/save_zhang.jr?video_id="+video_id,
...
<div style="padding: 20px;">
  <form enctype="multipart/form-data" id="myform" class="form-horizontal">
    <div class="form-group mingcheng">
      ...
      <div class="col-xs-9">
        <input type="text" onblur="check_zhang_name()" class="form-control" name="video_name" id="video_name" placeholder="章节名称">
      </div>
      <!-- <div class="col-xs-2">
    ...
    <div class="form-group">
      ...
      <div class="col-xs-9">
        <button type="button" onclick="save_zhang(${video_id})" class="btn btn-success btn-xm">提交</button>
