...
<script>
//修改新闻动态meta信息
function update_meta(course_id){
			 $("#myform").ajaxSubmit({
					type : 'POST',
					url : "/extend/update_meta.jr?course_id="+course_id,
...
<div style="padding: 20px;">
    ...
    <div class="form-group mingcheng">
      ...
      <div class="col-xs-8">
        <input type="text" class="form-control" value="${courseMenu.meta_title}" name="meta_title" id="meta_title" placeholder="页面标题">
      </div>
    </div>
    <div class="form-group">
       <label for="inputPassword1" class="col-xs-3 control-label">页面关键字：</label>
      <div class="col-xs-8">
        <input type="text" class="form-control" value="${courseMenu.meta_key}" name="meta_key" id="meta_key" placeholder="页面关键字">
      </div> 
    </div>
    <div class="form-group">
       <label for="inputPassword1" class="col-xs-3 control-label">页面描述：</label>
      <div class="col-xs-8">
        <input type="text" class="form-control" value="${courseMenu.meta_dis}" name="meta_dis" id="meta_dis" placeholder="页面描述">
      </div> 
    </div>
    <div class="form-group">
       <label for="inputPassword1" class="col-xs-3 control-label">&nbsp;</label>
      <div class="col-xs-9">
        <button type="button" onclick="update_meta(${courseMenu.course_id})" class="btn btn-success btn-xm">修改</button> 
      </div> 
    </div>
	</form>	
	</div>