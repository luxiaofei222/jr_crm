...
<form class="form-horizontal add_qiye_dialog"
	...
	<div class="form-group" style="margin-top: 15px;">
		<label class="col-xs-2 control-label right_wz">错误类型：</label> <label
			class="col-xs-6 control-label left_wz">${correctionQuestion.correction_type }</label>
	</div>
	<c:if test="${not empty correctionQuestion.correction_content }">
	<div class="form-group" style="margin-top: 15px;">
		<label class="col-xs-2 control-label right_wz">错误内容：</label> <label
			class="col-xs-6 control-label left_wz">${correctionQuestion.correction_content }</label>
	</div>
	</c:if>
	<div class="form-group" style="margin-top: 15px;">
		<label class="col-xs-2 control-label right_wz">题目：</label>
		<div class="col-xs-6">
			<textarea class="form-control" rows="4" id="question_name" style="color: #444;">${correctionQuestion.chapterQuestion.question_name }
        </textarea>
		</div>
		<div class="col-xs-1" style="position: relative;">
			<div class="image_container">
				<img id="preview" src="${correctionQuestion.chapterQuestion.question_name_pic }">
			</div>
		...
		<div class="col-xs-1">
			<button type="button" onclick="update_chapter_question(${correctionQuestion.chapterQuestion.chapter_question_id })" class="btn btn-primary btn-lg"
				style="width: 100px; margin-top: 20px;">修改</button>
		</div>
	</div>
		<c:forEach items="${correctionQuestion.chapterQuestion.chapterQuerstionOptions }" var="option">
	...
	<div class="form-group">
		...
		<div class="col-xs-6">
			<div id="summernote">${correctionQuestion.chapterQuestion.analysis }</div>
		</div>
		<div class="col-xs-1">
			<button type="button" class="btn btn-primary btn-lg"
				style="width: 100px; margin-top: 150px;" onclick="update_chapter_question(${correctionQuestion.chapterQuestion.chapter_question_id })">修改</button>
		</div>
	</div>
	<div class="form-group" style="margin-top: 15px;">
