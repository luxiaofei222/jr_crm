...
function tijiao_shenhe(entryInfoId){
	...
	$.post("/fin_entry_info/caiwushenhe.jr",{
		...
		'zongjian_yijian':caiwushenhe_message,
...
//提交给市场总监审核
function tijiaoshangji(entryInfoId){
	$.post("/fin_entry_info/caiwushenhe.jr",{
		'entryInfoId':entryInfoId,
		'entryInfoState':9
	},function(data){
...
<div class="shenhe" style="padding: 12px">
	<table width="750" border="1" class="baoming_feiyong">
		...
		<tr>
			...
			<td width="85%" colspan="6" class="shenhezt"><input type="radio"
				checked="checked" name="optionsRadios" data-toggle="radio" value="1"
				id="radio4a"> 通过 <input type="radio" name="optionsRadios"
				data-toggle="radio" value="0" id="radio4b"> 不通过</td>
		</tr>
		<tr class="yijian">
	...
	<div class="caozuo">
		<input class="btn btn-success btn-xm"
			...
			type="button"> <input class="btn btn-info btn-xm"
			onclick="tijiaoshangji(${entryInfo.entryInfoId })" value="提交上级"
			type="button">
	</div>
	<%-- <button type="button"
