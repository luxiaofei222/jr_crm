...
function info_jump_page(page,limit,entryUserName , documentNumber,entryUserPosition ,employee_id ,start_time ,end_time , entryplanId,university_id ,zhuanye_id ,mianshoubanxing ,isPay ,payType ,price,bao_start_time,bao_end_time ){
	jiazaidonghua();
	$.post("/fin_entry_info/get_entry_info_success.jr",{
...
function shaixuan_tioajian(obj,limit){
		...
		$("#myform").ajaxSubmit({
			type : 'POST',
			url : "/fin_entry_info/get_entry_info_success.jr",
			data:{
				'pageNumber':1,
				'limit':limit
			},
...
function daochu_entry_info(){
	layer.open({
		...
		area : [ '800px', '400px' ],
		shadeClose : true, //点击遮罩关闭
		content : "/fin_entry_info/to_daochu_entry_info.jr?info_state=2"
	});
}
</script>
<div class="back_right">
	<div class="back_r_top">
		<div class="left">审核成功</div>
			...
			<div class="content_message">
				...
				<c:forEach items="${entryInfos.list }" var="info" varStatus="vs">
                    ...
                    <tr>
							...
							<td>
							<button type="button" onclick="to_check_infopage(${info.entryInfoId })" class="btn btn-warning btn-xs">查看</button>
							<%-- <button type="button" onclick="to_check_condition(${info.entryInfoId })" class="btn btn-warning btn-xs">补缴费用</button> --%>
							</td>
						</tr>
					</c:forEach>
				</tbody>
			...
			<div class="pages">
			    <div class="whole left">
					<div class="go_page">
					  ...
					  <span>页</span>
					  <a href="javascript:void(0)" onclick="info_tiaozhuan_page(${entryInfos.pages},${limit},'${entryUserName }','${ documentNumber}','${entryUserPosition }','${employee_id }','${start_time }','${end_time }','${ entryplanId}','${university_id }','${zhuanye_id }','${mianshoubanxing }','${isPay }','${payType }','${price }','${bao_start_time }','${bao_end_time }')" class="btn_go">GO</a>
					</div>
				</div>
				<ul class="pagination right">
				 <li><a href="javascript:void(0)" onclick="info_jump_page(1,${limit },'${entryUserName }','${ documentNumber}','${entryUserPosition }','${employee_id }','${start_time }','${end_time }','${ entryplanId}','${university_id }','${zhuanye_id }','${mianshoubanxing }','${isPay }','${payType }','${price }','${bao_start_time }','${bao_end_time }')" class="fa fa-fast-backward"></a></li>
					...
					<c:forEach items="${entryInfos.navigatePageNumbers }" var="page">
						<c:choose>
							...
							<c:otherwise>
								<li onclick="info_jump_page(${page},${limit },'${entryUserName }','${ documentNumber}','${entryUserPosition }','${employee_id }','${start_time }','${end_time }','${ entryplanId}','${university_id }','${zhuanye_id }','${mianshoubanxing }','${isPay }','${payType }','${price }','${bao_start_time }','${bao_end_time }')"><a href="#fakelink">${page}</a></li>
							</c:otherwise>
						</c:choose>
					</c:forEach>
                ...
                <ul class="dropdown-menu">
                  <li><a href="#fakelink" onclick="info_jump_page(${entryInfos.pageNumber},20,'${entryUserName }','${ documentNumber}','${entryUserPosition }','${employee_id }','${start_time }','${end_time }','${ entryplanId}','${university_id }','${zhuanye_id }','${mianshoubanxing }','${isPay }','${payType }','${price }','${bao_start_time }','${bao_end_time }')">20</a></li>
                  <li><a href="#fakelink" onclick="info_jump_page(${entryInfos.pageNumber},50,'${entryUserName }','${ documentNumber}','${entryUserPosition }','${employee_id }','${start_time }','${end_time }','${ entryplanId}','${university_id }','${zhuanye_id }','${mianshoubanxing }','${isPay }','${payType }','${price }','${bao_start_time }','${bao_end_time }')">50</a></li>
                  <li><a href="#fakelink" onclick="info_jump_page(${entryInfos.pageNumber},100,'${entryUserName }','${ documentNumber}','${entryUserPosition }','${employee_id }','${start_time }','${end_time }','${ entryplanId}','${university_id }','${zhuanye_id }','${mianshoubanxing }','${isPay }','${payType }','${price }','${bao_start_time }','${bao_end_time }')">100</a></li>
                </ul>
              </li>
					<c:if test="${entryInfos.hasNextPage==true}">
						<li class="next" onclick="info_jump_page(${entryInfos.pageNumber+1},${limit },'${entryUserName }','${ documentNumber}','${entryUserPosition }','${employee_id }','${start_time }','${end_time }','${ entryplanId}','${university_id }','${zhuanye_id }','${mianshoubanxing }','${isPay }','${payType }','${price }','${bao_start_time }','${bao_end_time }')"><a
							href="#fakelink" class="fa fa-angle-right"></a></li>
					</c:if>
					<li onclick="info_jump_page(${entryInfos.pages},${limit },'${entryUserName }','${ documentNumber}','${entryUserPosition }','${employee_id }','${start_time }','${end_time }','${ entryplanId}','${university_id }','${zhuanye_id }','${mianshoubanxing }','${isPay }','${payType }','${price }','${bao_start_time }','${bao_end_time }')"><a href="javascript:void(0)" class="fa fa-fast-forward"></a></li>
				</ul>
			</div>
		</div>
