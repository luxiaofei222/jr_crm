...
<title>OA管理系统</title>
	...
	<link rel="stylesheet" type="text/css" href="/css/oa/index/htindex.css">
...
<body>
	<div class='wrapper'>
		<!-- 左侧菜单列表 -->
		<jsp:include page="/WEB-INF/back_page/common/oamenu.jsp"></jsp:include>
		<div class="ht_right"  id="conten_list">
			<!-- 右侧内容 -->
			<jsp:include page="/WEB-INF/back_page/oa_welcome.jsp"></jsp:include>
		</div>
	</div>
</body>
</html>