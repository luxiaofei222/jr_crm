...
<body>
	<ul>
		...
		<c:if test="${not empty oaTask.pingjia_content }">
		<li>
			<div class="item">
				<label class="left">任务评分：</label>
				<div class="info left">
					<c:forEach begin="1" end="${oaTask.pingfen }">
		...
		<li>
			<div class="item">
				...
				<div class="info left">
					<textarea disabled="disabled">${oaTask.pingjia_content }</textarea>
				</div>
			</div>
			<div class="clear"></div>
		</li>
		</c:if>
		<c:if test="${empty oaTask.pingjia_content }">
		<li>
			<div class="item">
				<label class="left">任务评分：</label>
				<div class="info left">
