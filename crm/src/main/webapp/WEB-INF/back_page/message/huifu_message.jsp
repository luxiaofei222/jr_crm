...
//添加信息动态信息
function send_message(message_id,user_id){
...
<div style="padding: 20px;">
    ...
    <div class="form-group">
      ...
      <div class="col-xs-9">
        	<label class="control-label" style="font-weight: normal;">${jrMessage.user_nickname }</label>
      </div>
    </div>
      <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="col-xs-9">
        <button type="button" onclick="send_message(${jrMessage.message_id },${jrMessage.user_id })" class="btn btn-success btn-xm">发送</button>
