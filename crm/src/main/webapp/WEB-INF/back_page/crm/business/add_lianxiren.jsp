...
<script>
//添加联系人信息信息
function save_lianxiren(company_id){
		$("#myform").ajaxSubmit({
			type : 'POST',
			url : "/crm_business/save_lianxiren.jr",
			data:{
...
<form class="form-horizontal add_qiye_dialog" enctype="multipart/form-data" id="myform" style="padding:21px;">
     <div class="form-group">
      ...
      <div class="col-xs-9">
        <input type="text" onblur="check_customer_depart()" class="form-control" name="customer_depart" id="customer_depart" placeholder="部门">  
      </div>
    </div>
    <div class="form-group">
      <label class="col-xs-2 control-label">职务：</label>
      <div class="col-xs-9">
        <input type="text" class="form-control" name="customer_position" id="customer_position" placeholder="职务">
      </div>
    </div>
    <div class="form-group">
      <label class="col-xs-2 control-label">联系人：</label>
      <div class="col-xs-9">
        <input type="text" class="form-control" onblur="check_customer_name()" name="customer_name" id="customer_name" placeholder="联系人">   
      </div>
    </div>    
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="col-xs-9">
        <input type="text" class="form-control" name="customer_officephone" id="customer_officephone" placeholder="办公电话"> 
      </div>
    </div>
    <div class="form-group">
      <label class="col-xs-2 control-label">手机：</label>
      <div class="col-xs-9">
        <input type="text" class="form-control" onblur="check_customer_phone()" name="customer_phone" id="customer_phone" placeholder="手机"> 
      </div>
    </div>
    <div class="form-group">
      <label class="col-xs-2 control-label">QQ：</label>
      <div class="col-xs-9">
        <input type="text" class="form-control" name="customer_qq" id="customer_qq" placeholder="QQ"> 
      </div>
    </div>
    <div class="form-group">
      <label class="col-xs-2 control-label">微信：</label>
      <div class="col-xs-9">
        <input type="text" class="form-control" name="customer_weixin" id="customer_weixin" placeholder="微信"> 
      </div>
    </div>
    <div class="form-group">
      <label class="col-xs-2 control-label">邮箱：</label>
      <div class="col-xs-9">
        <input type="text" class="form-control" name="customer_mail" id="customer_mail" placeholder="邮箱"> 
      </div>
    </div>
    <div class="form-group">
      <label class="col-xs-2 control-label">备注：</label>
      <div class="col-xs-9">
        <textarea class="form-control" name="customer_note" id="customer_note"></textarea> 
      </div>
    </div>
    <div class="form-group">
       <label for="inputPassword1" class="col-xs-2 control-label">&nbsp;</label>
      <div class="col-xs-9">
        <button type="button" onclick="save_lianxiren(${company_id})" class="btn btn-success btn-xm">提交</button>
