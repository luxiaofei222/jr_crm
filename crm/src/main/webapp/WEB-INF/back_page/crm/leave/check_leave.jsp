...
<body>
  ...
  <form enctype="multipart/form-data" id="myform"
    ...
    <div class="form-group">
      ...
      <div class="col-xs-10">
      <c:if test="${backLeave.leave_state==0 && sessionScope.employee_session.employee_id!=47 }">
        <button type="button" onclick="tijiao_leave(${backLeave.leave_id})" class="btn btn-info btn-xm">提交</button>
       </c:if>
       <c:if test="${backLeave.leave_state==1 && sessionScope.employee_session.employee_id==47 }">
        <button type="button" onclick="tijiao_leave(${backLeave.leave_id})" class="btn btn-info btn-xm">提交</button>
       </c:if>
