...
<body>
  ...
  <form enctype="multipart/form-data" id="myform"
    ...
    <div class="form-group">
      ...
      <div class="col-xs-10">
      <c:if test="${desertJob.desert_state==0 && sessionScope.employee_session.employee_id!=47 }">
        <button type="button" onclick="tijiao_leave(${desertJob.desert_id})" class="btn btn-info btn-xm">提交</button>
       </c:if>
       <c:if test="${desertJob.desert_state==1 && sessionScope.employee_session.employee_id==47 }">
        <button type="button" onclick="tijiao_leave(${desertJob.desert_id})" class="btn btn-info btn-xm">提交</button>
       </c:if>
