...
<script src="/js/crm/call/record.js"></script>
<style>
.select2-chosen{
	...
	<div class="back_r_top">
		...
		<form enctype="multipart/form-data" id="myform" class="form-horizontal">
			<div class="form-group clearfix"  style="padding-top: 10px;">
				...
				<label class="col-xs-1 right_wz">坐席人员：</label>
				<select class="col-xs-2" name="employee_id" style="line-height:35px;height:35px;">
					<option value="">请选择</option>
					<c:forEach items="${employees }" var="employee">
					<option value="${employee.employee_id }">${employee.employee_name }(${employee.zuoxi })</option>
					</c:forEach>
				</select>
			</div>
			...
			<div class="operation">
				<div class="opera_left left">
					...
					<button type="button" onclick="down_load_excel(this)" class="btn left">
						<i class="fa fa-cloud-download"></i>导出通话记录
					</button>
					<button type="button" onclick="down_load_tage()" class="btn left">
						<i class="fa fa-cloud-download"></i>导出通话录音
					</button>
				</div>
			</div>
			<div class="content_message">
				...
				<c:forEach items="${businessCallRecords.list }" var="record" varStatus="vs">
                    ...
                    <tr>
							...
							<i class="fa fa-play-circle two" onclick="listen_the_tape(${record.record_id },'${record.crm_recourd_uid}','${record.shijianchuo }',1)" title="试听录音"></i>
							</c:if>
			...
			<div class="pages">
				<div class="whole left">
					<div class="go_page">
					  ...
					  <span>页</span>
					  <a href="javascript:void(0)" onclick="record_tiaozhuan_page(${businessCallRecords.pages},${limit},'${start_time }','${end_time }','${employee_id }','${beijiao }','${zhujiao }','${record_state }','${record_type }','${start_shichang }','${end_shichang }')" class="btn_go">GO</a>
					</div>
				</div>
				<ul class="pagination right">
				    <li><a href="javascript:void(0)" onclick="record_jump_page(1,${limit },'${start_time }','${end_time }','${employee_id }','${beijiao }','${zhujiao }','${record_state }','${record_type }','${start_shichang }','${end_shichang }')" class="fa fa-fast-backward"></a></li>
					<c:if test="${businessCallRecords.hasPreviousPage==true}">
						<li class="previous"
							onclick="record_jump_page(${businessCallRecords.pageNumber-1},${limit },'${start_time }','${end_time }','${employee_id }','${beijiao }','${zhujiao }','${record_state }','${record_type }','${start_shichang }','${end_shichang }')"><a
					...
					<c:forEach items="${businessCallRecords.navigatePageNumbers }" var="page">
						<c:choose>
							...
							<c:otherwise>
								<li onclick="record_jump_page(${page},${limit },'${start_time }','${end_time }','${employee_id }','${beijiao }','${zhujiao }','${record_state }','${record_type }','${start_shichang }','${end_shichang }')"><a href="#fakelink">${page}</a></li>
							</c:otherwise>
						</c:choose>
					</c:forEach>
                ...
                <ul class="dropdown-menu">
                  <li><a href="#fakelink" onclick="record_jump_page(${businessCallRecords.pageNumber},20,'${start_time }','${end_time }','${employee_id }','${beijiao }','${zhujiao }','${record_state }','${record_type }','${start_shichang }','${end_shichang }')">20</a></li>
                  <li><a href="#fakelink" onclick="record_jump_page(${businessCallRecords.pageNumber},50,'${start_time }','${end_time }','${employee_id }','${beijiao }','${zhujiao }','${record_state }','${record_type }','${start_shichang }','${end_shichang }')">50</a></li>
                  <li><a href="#fakelink" onclick="record_jump_page(${businessCallRecords.pageNumber},100,'${start_time }','${end_time }','${employee_id }','${beijiao }','${zhujiao }','${record_state }','${record_type }','${start_shichang }','${end_shichang }')">100</a></li>
                </ul>
              </li>
					<c:if test="${businessCallRecords.hasNextPage==true}">
						<li class="next" onclick="record_jump_page(${businessCallRecords.pageNumber+1},${limit },'${start_time }','${end_time }','${employee_id }','${beijiao }','${zhujiao }','${record_state }','${record_type }','${start_shichang }','${end_shichang }')"><a
							href="#fakelink" class="fa fa-angle-right"></a></li>
					</c:if>
					<li onclick="record_jump_page(${businessCallRecords.pages},${limit },'${start_time }','${end_time }','${employee_id }','${beijiao }','${zhujiao }','${record_state }','${record_type }','${start_shichang }','${end_shichang }')"><a href="javascript:void(0)" class="fa fa-fast-forward"></a></li>
				</ul>
			</div>
		    <div class="clear"></div>
		</div>
