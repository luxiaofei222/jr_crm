...
$(function(){
	$.post("/crm_call/get_bumen_call_echart.jr",function(data){
		baobiao(data);
...
function chaxun_call_chart(obj,page,limit){
	...
	$("#myform").ajaxSubmit({
		type : 'POST',
		url : "/crm_call/get_bumen_call_echart.jr",
		data:{
			'pageNumber':page,
			'limit':limit
		},
	...
	<div class="right_content" style="height: 100%;">
		...
		<div class="operation">
			<div class="opera_left left">
				<button type="button"
					onclick="to_check_echart(${pageNumber},${limit })" class="btn left">
					<i class="fa fa-refresh"></i>刷新
				</button>
				<button type="button"
					onclick="record_jump_page(${pageNumber},${limit })"
					class="btn left">
