		...
		<form enctype="multipart/form-data" id="myform" class="form-horizontal">
			...
			<div class="operation">
				<div class="opera_left left">
					<button type="button" onclick="refresh_business_record(${employees.pageNumber},${limit },'${start_time }','${end_time }','${employee_id }','${record_type }','${bumen_id }')" class="btn left">
						<i class="fa fa-refresh"></i>刷新
					</button>
					<button type="button" onclick="to_check_echart(${employees.pageNumber},${limit },'${start_time }','${end_time }','${employee_id }','${record_type }','${bumen_id }')" class="btn left">
			...
			<div class="pages">
				<div class="whole left">
					<div class="go_page">
					  ...
					  <span>页</span>
					  <a href="javascript:void(0)" onclick="record_tiaozhuan_page(${employees.pages},${limit},'${start_time }','${end_time }','${employee_id }','${record_type }','${bumen_id }')" class="btn_go">GO</a>
					</div>
				</div>
				<ul class="pagination right">
				    <li><a href="javascript:void(0)" onclick="record_jump_page(1,${limit },'${start_time }','${end_time }','${employee_id }','${record_type }','${bumen_id }')" class="fa fa-fast-backward"></a></li>
					<c:if test="${employees.hasPreviousPage==true}">
						<li class="previous"
							onclick="record_jump_page(${employees.pageNumber-1},${limit },'${start_time }','${end_time }','${employee_id }','${record_type }','${bumen_id }')"><a
					...
					<c:forEach items="${employees.navigatePageNumbers }" var="page">
						<c:choose>
							...
							<c:otherwise>
								<li onclick="record_jump_page(${page},${limit },'${start_time }','${end_time }','${employee_id }','${record_type }','${bumen_id }')"><a href="#fakelink">${page}</a></li>
							</c:otherwise>
						</c:choose>
					</c:forEach>
                ...
                <ul class="dropdown-menu">
                  <li><a href="#fakelink" onclick="record_jump_page(${employees.pageNumber},20,'${start_time }','${end_time }','${employee_id }','${record_type }','${bumen_id }')">20</a></li>
                  <li><a href="#fakelink" onclick="record_jump_page(${employees.pageNumber},50,'${start_time }','${end_time }','${employee_id }','${record_type }','${bumen_id }')">50</a></li>
                  <li><a href="#fakelink" onclick="record_jump_page(${employees.pageNumber},100,'${start_time }','${end_time }','${employee_id }','${record_type }','${bumen_id }')">100</a></li>
                </ul>
              </li>
					<c:if test="${employees.hasNextPage==true}">
						<li class="next" onclick="record_jump_page(${employees.pageNumber+1},${limit },'${start_time }','${end_time }','${employee_id }','${record_type }','${bumen_id }')"><a
							href="#fakelink" class="fa fa-angle-right"></a></li>
					</c:if>
					<li onclick="record_jump_page(${employees.pages},${limit },'${start_time }','${end_time }','${employee_id }','${record_type }','${bumen_id }')"><a href="javascript:void(0)" class="fa fa-fast-forward"></a></li>
				</ul>
			</div>
		    <div class="clear"></div>
		</div>
