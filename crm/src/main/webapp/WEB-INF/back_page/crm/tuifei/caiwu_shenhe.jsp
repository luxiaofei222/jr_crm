...
<div class="shenhe" style="padding: 12px">
	...
	<div class="caozuo">
		<input class="btn btn-success btn-xm"
			onclick="tijiao_shenhe(${entryInfo.entryInfoId },5)" value="同意"
			type="button">
		<input class="btn btn-success btn-xm"
			onclick="tijiao_shenhe(${entryInfo.entryInfoId },6)" value="拒绝"
			type="button">
