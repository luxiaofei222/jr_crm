...
<script>
//添加学校教材计划
function update_chengkao_material(obj,material_id,info){
	var zhuanye_id=$("#zhuanye_id").val();
	if(zhuanye_id!=0){
		 $(obj).attr("disabled","disabled"); 
			$("#myform").ajaxSubmit({
				type : 'POST',
				data:{'material_id':material_id,'info':info},
				url : "/material/update_chengkao_material.jr",
...
//获取专业
function get_zhuanye(chengkao_id){
...
<div class="tianjia_xuexiao">
	...
	<form class="form-horizontal" enctype="multipart/form-data" id="myform"
		...
		<div class="form-group">
			...
			<div class="col-xs-10">
				<select id="cengci" name="cengci" onchange="get_zhuanye(${ckZhaoSheng.chengkao_id })">
					<option value="${material.cengci }">${material.cengci }</option>
		...
		<div class="form-group">
			...
			<div class="col-xs-10">
				...
				<c:if test="${material.zhuanye_id==chengkao.chengkao_id  }">
				...
				<c:if test="${material.zhuanye_id==wangjiao.university_id  }">
					<option selected="selected" value="${wangjiao.university_id }">${wangjiao.university_zhuanye }</option>
				</c:if>
				<c:if test="${material.zhuanye_id!=wangjiao.university_id  }">
		...
		<div class="form-group">
			...
			<div class="col-xs-10">
				...
				<option value="${material.material_jihua }">${material.material_jihua }</option>
		...
		<div class="form-group">
			...
			<div class="col-xs-10">
				...
				<option value="${material.ruxue_pici }">${material.ruxue_pici }</option>
					<c:if test="${info==0 }">
		...
		<div class="form-group">
			...
			<div class="col-xs-10">
				<input type="text" id="zongxuefen" name="zongxuefen" value="${material.zongxuefen }" />
			</div>
		</div>
		<div class="form-group">
			<label class="col-xs-2 control-label">必修课总学分：</label>
			<div class="col-xs-10">
				<input type="text" id="bixiuxuefen" name="bixiuxuefen" value="${material.bixiuxuefen }" />
			</div>
		</div>
		<div class="form-group">
			<label class="col-xs-2 control-label">选修课总学分：</label>
			<div class="col-xs-10">
				<input type="text" id="xuanxiuxuefen" name="xuanxiuxuefen" value="${material.xuanxiuxuefen }" />
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-xs-10">
				<input type="button"
					onclick="update_chengkao_material(this,${material.material_id},${info })"
