...
<script>
	...
	//发送反馈内容
	function send_fankui(obj,leave_id){
		...
		if(fankui!=null&&fankui!=""){
			...
			$(obj).val("发送中");
			$.post("/back_leave/update_xiaojia_leave.jr",{
				'leave_id':leave_id,
				'beizhu':fankui
			},function(data){
				if(data==1){
...
<body>
	<div class="sixin">
		...
		<textarea placeholder="如果销假时间超时太晚请说明情况" id="fankui"></textarea>
		<a href="javascript:void(0)" onclick="close_layer()">关闭</a><input
			type="button" onclick="send_fankui(this,${backLeave.leave_id})"
			class="send" value="发送" />
		<div class="clear"></div>
	</div>
</body>
