	...
	<label class="radio" for="radio4b${condition.entrycondition_id }"> <input type="radio" 
	  ...
	  <td colspan="3">
	    <select id="zhuanye_id" name="zhuanye_id" onchange="get_kelei()">
	    	<option value="${chengkaoSc.chengkao_id}">${chengkaoSc.chengkao_name}</option>
		</select>
	  </td>
	  <td><strong>科类</strong></td>
	  <td>
	    <input type="text" class="layui-input" id="kelei" value="${chengkaoSc.kelei }" readonly="readonly" />
	  </td>
   ...
   <tr>
	  ...
	  <td>
	    <select id="biye_leibie" name="biye_leibie">
	      <option value="${entryInfo.biye_leibie}">${entryInfo.biye_leibie}</option>
	  ...
	  <td colspan="3">
	    <select id="zhiye_leibie" name="zhiye_leibie">
	      <option value="${entryInfo.zhiye_leibie}">${entryInfo.zhiye_leibie}</option>
	  ...
	  <td>
	    <select id="is_nongmin" name="is_nongmin">
	            <option value="${entryInfo.is_nongmin}">${entryInfo.is_nongmin}</option>
	...
	<tr>
	  ...
	  <td colspan="7"><input type="text" placeholder="请输入确认地点" id="queendian" name="queendian" value="${entryInfo.queendian}" /></td>
	</tr>
	<tr>
		<td><strong>手机号</strong></td>
		<td><input type="text" onblur="check_entryUserPhone()"
			placeholder="请输入手机号" id="entryUserPhone" name="entryUserPhone" value="${entryInfo.entryUserPhone}" /></td>
		<td><strong>电子邮箱</strong></td>
		<td colspan="3"><input type="text" onblur="check_entryUserMail()"
			placeholder="请输入电子邮箱" id="entryUserMail" name="entryUserMail" value="${entryInfo.entryUserMail}" /></td>
