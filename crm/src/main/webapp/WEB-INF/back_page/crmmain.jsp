...
<title>CRM管理系统</title>
	...
	<link rel="stylesheet" type="text/css" href="/css/crm/index/htindex.css">
...
<!-- <script type="text/javascript" src="/js/crm/call/uucall.js"></script> -->
</head>
<body>
	<div class='wrapper'>
		<!-- 左侧菜单列表 -->
		<jsp:include page="/WEB-INF/back_page/common/crmmenu.jsp"></jsp:include>
		<div class="ht_right"  id="conten_list">
			<!-- 右侧内容 -->
			<jsp:include page="/WEB-INF/back_page/crm_welcome.jsp"></jsp:include>
		</div>
	</div>
</body>
</html>