...
public class Pagers<T> {
	...
	public Pagers(int total, int pageNumber) {
		init(total, pageNumber, limit);
	}

	public Pagers(int total, int pageNumber, int limit) {
		init(total, pageNumber, limit);
	}
	...
	public int getBegin() {// 后台计算编号公式--------------
		begin = (this.pageNumber - 1) * this.limit;
		return begin;
	}
